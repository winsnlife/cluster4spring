...
public class LastAccessTimeEndpointSelectionPolicy<E extends Endpoint<SI>, SI extends ServiceMoniker>
    ...
    protected static final Log fLog = LogFactory.getLog(LastAccessTimeEndpointSelectionPolicy.class);
    ...
    public E selectServiceEndpoint(List<E> aEndpoints)
        ...
        long previousEndpointID = Long.MAX_VALUE;

        for (E endpoint : aEndpoints) {
            long endpointTime = endpoint.getLastAccessTime();
            long endpointID = endpoint.getServiceInfo().getServerID();
            if (lastAccessedEndpoint == null) {
                ...
                if (previousEndpointID != endpointID) {
